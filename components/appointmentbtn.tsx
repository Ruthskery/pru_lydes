...
const Tooltip = () => {
  return (
    <div className="group relative flex justify-center items-right text-zinc-600 text-sm font-bold">
...
const CalendlyPopupWithTooltip = () => {
  ...
  return (
    <div className="relative">
      <Tooltip /> {/* Tooltip will be displayed */}
      <PopupWidget
...
export default CalendlyPopupWithTooltip;
