  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-2 w-[90%] mx-auto gap-12 md:gap-16 items-center justify-center text-center">
        ...
        >
          <h1 className="text-xl md:text-2xl lg:text-3xl font-bold uppercase mb-3">
            About Me
          </h1>
          ...
          {/* Scrolling Carousel */}
          <div className="overflow-hidden mt-3 w-full max-w-[600px] mx-auto relative">
            ...
            <div className="scrolling-carousel">
              {[...titles, ...titles].map((title, index) => (
                <div
                  key={index}
                  className="carousel-item text-gray-700 text-sm md:text-base font-medium"
                >
                  {title}
          ...
          <p className="text-base md:text-lg w-full leading-relaxed text-gray-700 mt-4 text-justify">
            Lydes, a top financial consultant at Pru Life UK, is recognized
            nationwide for her expertise in strategic financial planning. With a
            deep passion for helping individuals achieve financial security, she
            has built a strong reputation for guiding clients toward long-term
            financial success with confidence and precision.
          </p>
          ...
          <p className="text-base md:text-lg w-full leading-relaxed text-gray-700 mt-2 text-justify">
            To create a financially empowered community where individuals and
            families achieve lasting prosperity through smart, strategic
            financial decisions. My vision is to be a trusted leader in
            financial consulting, transforming lives by providing security,
            growth, and peace of mind for generations to come.
          </p>
          ...
          <p className="text-base md:text-lg w-full leading-relaxed text-gray-700 mt-2 text-justify">
            To educate, guide, and empower every Filipino household with
            personalized financial solutions that ensure stability and growth.
            Through Pru Life UK, I am committed to providing exceptional
            financial planning services that safeguard the future of my clients,
