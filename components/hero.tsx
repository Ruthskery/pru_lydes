      ...
      <div className="flex flex-col xl:flex-row h-full">
        ...
        <div className="flex-1 flex flex-col items-center text-center justify-center px-6 md:mb-10 lg:mb-30 xl:mb-0">
          <div className="flex flex-col font-[Montserrat] items-center text-center z-20 relative">
            ...
            <p className="text-[#14110F] font-[Montserrat] text-sm md:text-lg lg:text-xl xl:text-lg mb-6 max-w-6xl lg:px-50 xl:px-0">
          ...
          <div className="flex text-black items-end gap-2 md:gap-4 mb-20 xl:mb-0 text-xl md:text-5xl lg:text-5xl">
