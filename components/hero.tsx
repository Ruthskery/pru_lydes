  ...
  return (
    <div className={`relative w-full h-350 min-h-screen bg-gradient-to-b from-[#E1B951] to-[#14110F] dark:to-[#AE851E] ${montserrat.variable} ${roboto.variable}`}>
      ...
      <div className="flex flex-col font-[Montserrat] items-center text-center pt-40 px-4 z-20 relative">
        ...
        <p className="text-white dark:text-[#14110F] font-[Roboto] text-lg md:text-xl mb-6 max-w-6xl">
        ...
        <div className="flex bg-white dark:text-[#14110F] rounded-full overflow-hidden inset-shadow-sm w-auto">
          ...
          />
          <button className="bg-[#d6a741] m-1 text-xl text-white dark:text-[#14110F] px-9 py-2 rounded-full hover:bg-[#e1b951] transition">
            Send
          </button>
        </div>
      </div>
