          ...
          <div className="input-box ">
            <div className="floating-label">
              <input
                ...
                max="100"
                className={`${
                  errors.age ? 'border-red-500' : 'border-white dark:border-[#14110f]'
                } text-white dark:text-[#69584F]`}
                placeholder=" "
                name="age"
                required
          ...
          <div className="input-box ">
            <div className="floating-label">
              ...
              >
                ...
                <option value="Health & Critical Illness">Health & Critical Illness</option>
                <option value="Investment-Linked">Investment-Linked</option>
                <option value="Accident & Disability">Accident & Disability</option>
