...
function DarkmodeToggle() {
  ...
  return (
    <button
    onClick={toggleTheme}
    className="w-14 h-8 flex items-center bg-black dark:bg-black rounded-full p-1 transition-all relative"
  >
    <div
    ...
    >
      <div className="flex items-center justify-center h-full">
        {darkMode ? <SunMedium size={16} className="text-yellow-500" /> : <Moon size={16} className="text-black" />}
      </div>
    </div>
  </button>
